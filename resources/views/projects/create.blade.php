            ...
            <div class="row pt-5 col-md-12 col-lg-12 col-sm-12" style=" margin: 10px;">
                <form action="{{ route('projects.store')}}" class="form-control" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="project-name" class="form-control" placeholder="Enter name"
                            required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="project-content" class="form-control autosize-target text-left"
                            placeholder="Enter description" rows="5" style="resize: verticle;"></textarea>
                    </div>
